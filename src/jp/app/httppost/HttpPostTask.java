...
public class HttpPostTask extends AsyncTask<Void, Void, Void> {
	...
	/** バックグラウンドで実行 */
	public HttpPostTask(String post_url, Handler ui_handler) {
		// 初期化
	...
	public void addPostParam(String post_name, String post_value) {
		Log.e("post param", "name: "+post_name+"   value: "+post_value);	//TODO
		...
		response_handler = new ResponseHandler<Void>() {
			...
			public Void handleResponse(HttpResponse response) throws IOException {
				...
				default:
					...
					Log.e("posttest", EntityUtils.toString(response.getEntity(), HttpPostTask.this.response_encoding));
